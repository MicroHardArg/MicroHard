...
export default function DetallePresupuesto() {
  ...
  return (
    ...
    <section class="relative z-10 overflow-hidden bg-white py-8 lg:py-[120px]">
    <div className="flex items-center justify-center" >

          <div class=" px-10 lg:w-1/2 xl:w-8/12">
...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg px-full">
  ...
  <div>
            {!printing && (
        <button
          className="mt-12 bg-gray-500 hover:bg-gray-700 text-white font-bold py-4 px-6 rounded-full text-xl"
          onClick={handlePrint}
        >
          <p className="p no-print">Imprimir</p>
        </button>
      )}
