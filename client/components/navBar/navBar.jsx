        ...
        <ul className="flex-col md:flex-row flex md:space-x-10 mt-4 md:mt-0 md:text-sm md:font-medium">
            ...
            <li className='pl-30'>
                ...
                <div id="dropdownNavbar2" className="hidden bg-zinc-400 text-base z-10 list-none divide-y divide-gray-300 rounded shadow my-4 w-44">
                    <ul className="py-1" aria-labelledby="dropdownLargeButton">
                    <li>
                        <a href="/recurring" className="text-sm hover:bg-gray-100 text-gray-700 block px-4 py-2">Servicios</a>
                    </li>
                    <li>
                        <a href="/getServicios" className="text-sm hover:bg-gray-100 text-gray-700 block px-4 py-2">Lista Servicios</a>
                    </li>
                    </ul>
                </div>
            </li>
            ...
            <li className='pl-30'>
                <button id="Itemslist" data-dropdown-toggle="dropdownNavbar3" className="text-white hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 pl-3 pr-4 py-2 md:hover:text-blue-500 md:p-0 font-medium flex items-center justify-between w-full md:w-auto">Items <svg className="w-4 h-4 ml-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path></svg></button>

                {/* Dropdown menu */}

                <div id="dropdownNavbar3" className="hidden bg-zinc-400 text-base z-10 list-none divide-y divide-gray-300 rounded shadow my-4 w-44">
                    <ul className="py-1" aria-labelledby="dropdownLargeButton">
                    <li>
                        <a href="/recurring" className="text-sm hover:bg-gray-100 text-gray-700 block px-4 py-2">Servicios</a>
                    </li>
